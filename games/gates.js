(function(){
  ...
  window.spinGates = async function(){
    const bet = parseInt(document.getElementById('betInput-gates').value, 10);
    ...
    document.getElementById('gates-res').textContent = raw > 0 ? `Won ${raw} coins` : 'No win';
